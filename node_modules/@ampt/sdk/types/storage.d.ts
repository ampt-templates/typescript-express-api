...
export interface StorageEventHandler {
  (event: { name: 'write' | 'remove' | 'copy'; path: string; size: number }, context: HandlerContext): void
}
...
export declare interface Storage {
  ...
  on(specifier: ListenerPath | ListenerPath[], config: { timeout: number }, handler: StorageEventHandler): void
...
export declare function storage(bucket?: string): Storage
