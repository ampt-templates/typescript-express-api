...
export interface EventHandlerFunction {
  (event: any, context: HandlerContext): void
}

export declare interface Events {
  on(name: string, handler: EventHandlerFunction): Handler | null
  on(name: string, config: { timeout: number }, handler: EventHandlerFunction): Handler | null
