      ...
      if (isRetryStrategyV2(retryStrategy)) {
        ...
        while (true) {
          try {
            ...
            const retryErrorInfo = getRetyErrorInto(e5);
...
var init_exceptions = __esm({
  "../../node_modules/@aws-sdk/smithy-client/dist-es/exceptions.js"() {
    ...
    decorateServiceException = (exception, additions = {}) => {
      Object.entries(additions).filter(([, v2]) => v2 !== void 0).forEach(([k5, v2]) => {
  ...
  "../../node_modules/fast-xml-parser/src/xmlparser/DocTypeReader.js"(exports, module2) {
    function readDocType(xmlData, i5) {
      ...
      if (xmlData[i5 + 3] === "O" && xmlData[i5 + 4] === "C" && xmlData[i5 + 5] === "T" && xmlData[i5 + 6] === "Y" && xmlData[i5 + 7] === "P" && xmlData[i5 + 8] === "E") {
        ...
        for (; i5 < xmlData.length; i5++) {
          if (xmlData[i5] === "<") {
            if (hasBody && xmlData[i5 + 1] === "!" && xmlData[i5 + 2] === "E" && xmlData[i5 + 3] === "N" && xmlData[i5 + 4] === "T" && xmlData[i5 + 5] === "I" && xmlData[i5 + 6] === "T" && xmlData[i5 + 7] === "Y") {
              i5 += 7;
              entity = true;
            } else if (hasBody && xmlData[i5 + 1] === "!" && xmlData[i5 + 2] === "E" && xmlData[i5 + 3] === "L" && xmlData[i5 + 4] === "E" && xmlData[i5 + 5] === "M" && xmlData[i5 + 6] === "E" && xmlData[i5 + 7] === "N" && xmlData[i5 + 8] === "T") {
              i5 += 8;
            } else if (hasBody && xmlData[i5 + 1] === "!" && xmlData[i5 + 2] === "A" && xmlData[i5 + 3] === "T" && xmlData[i5 + 4] === "T" && xmlData[i5 + 5] === "L" && xmlData[i5 + 6] === "I" && xmlData[i5 + 7] === "S" && xmlData[i5 + 8] === "T") {
              i5 += 8;
            } else if (hasBody && xmlData[i5 + 1] === "!" && xmlData[i5 + 2] === "N" && xmlData[i5 + 3] === "O" && xmlData[i5 + 4] === "T" && xmlData[i5 + 5] === "A" && xmlData[i5 + 6] === "T" && xmlData[i5 + 7] === "I" && xmlData[i5 + 8] === "O" && xmlData[i5 + 9] === "N") {
              i5 += 9;
            } else if (
              //comment
              xmlData[i5 + 1] === "!" && xmlData[i5 + 2] === "-" && xmlData[i5 + 3] === "-"
            ) {
              comment = true;
            } else {
...
var init_AssumeRoleWithWebIdentityCommand = __esm({
  "../../node_modules/@aws-sdk/client-sts/dist-es/commands/AssumeRoleWithWebIdentityCommand.js"() {
    ...
    init_models_0();
    init_Aws_query();
    AssumeRoleWithWebIdentityCommand = class extends Command {
      constructor(input) {
        super();
        this.input = input;
      }
      ...
      for (let line of iniData.split(/\r?\n/)) {
        ...
        if (isSection) {
          ...
          if (isAssignment) {
            ...
            map4[currentSection][name] = value;
          }
        }
      }
      return map4;
...
var init_models_02 = __esm({
  "../../node_modules/@aws-sdk/client-sso/dist-es/models/models_0.js"() {
    ...
    InvalidRequestException = class extends SSOServiceException {
      constructor(opts) {
        super({
...
var init_GetRoleCredentialsCommand = __esm({
  "../../node_modules/@aws-sdk/client-sso/dist-es/commands/GetRoleCredentialsCommand.js"() {
    ...
    init_models_02();
    init_Aws_restJson1();
    GetRoleCredentialsCommand = class extends Command {
      constructor(input) {
        super();
        this.input = input;
      }
...
var init_partition = __esm({
  "../../node_modules/@aws-sdk/util-endpoints/dist-es/lib/aws/partition.js"() {
    ...
    DEFAULT_PARTITION = partitions.find((partition2) => partition2.id === "aws");
    partition = (value) => {
      ...
      const whatwgURL = (() => {
        try {
          ...
          if (typeof value === "object" && "hostname" in value) {
            ...
            url.search = Object.entries(query).map(([k5, v2]) => `${k5}=${v2}`).join("&");
            return url;
          }
...
var init_resolveEndpoint = __esm({
  "../../node_modules/@aws-sdk/util-endpoints/dist-es/resolveEndpoint.js"() {
    ...
    resolveEndpoint = (ruleSetObject, options) => {
      ...
      const requiredParams = Object.entries(parameters).filter(([, v2]) => v2.required).map(([k5]) => k5);
...
var init_models_03 = __esm({
  "../../node_modules/@aws-sdk/client-sso-oidc/dist-es/models/models_0.js"() {
    ...
    ExpiredTokenException2 = class extends SSOOIDCServiceException {
      constructor(opts) {
        super({
          name: "ExpiredTokenException",
          $fault: "client",
    ...
    InvalidRequestException2 = class extends SSOOIDCServiceException {
      constructor(opts) {
        super({
          name: "InvalidRequestException",
          $fault: "client",
...
var init_CreateTokenCommand = __esm({
  "../../node_modules/@aws-sdk/client-sso-oidc/dist-es/commands/CreateTokenCommand.js"() {
    ...
    init_models_03();
    init_Aws_restJson12();
    CreateTokenCommand = class extends Command {
      constructor(input) {
        super();
        this.input = input;
      }
...
var init_models_04 = __esm({
  "../../node_modules/@aws-sdk/client-cognito-identity/dist-es/models/models_0.js"() {
    ...
    TooManyRequestsException2 = class extends CognitoIdentityServiceException {
      constructor(opts) {
        super({
          name: "TooManyRequestsException",
          $fault: "client",
    ...
    ResourceNotFoundException2 = class extends CognitoIdentityServiceException {
      constructor(opts) {
        super({
          name: "ResourceNotFoundException",
          $fault: "client",
...
var init_GetCredentialsForIdentityCommand = __esm({
  "../../node_modules/@aws-sdk/client-cognito-identity/dist-es/commands/GetCredentialsForIdentityCommand.js"() {
    ...
    init_models_04();
    init_Aws_json1_1();
    GetCredentialsForIdentityCommand = class extends Command {
      constructor(input) {
        super();
        this.input = input;
      }
...
var init_GetIdCommand = __esm({
  "../../node_modules/@aws-sdk/client-cognito-identity/dist-es/commands/GetIdCommand.js"() {
    ...
    init_models_04();
    init_Aws_json1_1();
    GetIdCommand = class extends Command {
      constructor(input) {
        super();
        this.input = input;
      }
...
var AwsClient = class {
  ...
  async fetch(input, init) {
    for (let i5 = 0; i5 <= this.retries; i5++) {
      ...
      await new Promise((resolve) => setTimeout(resolve, Math.random() * this.initRetryMs * Math.pow(2, i5)));
    }
...
var AwsV4Signer = class {
  constructor({ method, url, headers, body, accessKeyId, secretAccessKey, sessionToken, service, region, cache, datetime, signQuery, appendSessionToken, allHeaders, singleEncode }) {
    ...
    this.encodedSearch = [...this.url.searchParams].filter(([k5]) => {
      if (!k5)
        return false;
      if (this.service === "s3") {
        if (seenKeys.has(k5))
      ...
      return true;
    }).map((pair) => pair.map((p5) => encodeRfc3986(encodeURIComponent(p5)))).sort(([k1, v1], [k22, v2]) => k1 < k22 ? -1 : k1 > k22 ? 1 : v1 < v2 ? -1 : v1 > v2 ? 1 : 0).map((pair) => pair.join("=")).join("&");
  }
  async sign() {
    if (this.signQuery) {
...
function buf2hex(buffer) {
  return Array.prototype.map.call(new Uint8Array(buffer), (x2) => ("0" + x2.toString(16)).slice(-2)).join("");
}
function encodeRfc3986(urlEncodedStr) {
  return urlEncodedStr.replace(/[!'()*]/g, (c5) => "%" + c5.charCodeAt(0).toString(16).toUpperCase());
}
...
async function loadCredentials() {
  ...
  const defaultProvider3 = await loadDefaultProvider();
  for (let attempt = 0; attempt < 10; attempt++) {
    try {
      return await defaultProvider3();
    } catch (err) {
...
function getFramework(app) {
  ...
  if (typeof app.ready === "function") {
    return async (request2) => {
      const response = new ServerlessResponse(request2);
      await app.ready();
      app.server.emit("request", request2, response);
      return response;
    };
  }
...
function createRequest(request2, context) {
  const httpHeaders = {};
...
function nodeAdapter(handler) {
  ...
  return async function(requestEvent, context) {
    const request2 = createRequest(requestEvent, context);
    const response = await getResponse(request2);
...
async function getStaticAssetObject(relativePath) {
  ...
  const s3url = `https://${process.env.STORAGE_BUCKET}.s3.${process.env.AWS_REGION}.amazonaws.com/static-assets/${import_node_path.default.posix.join(process.env.AMPT_ASSETS_LOCATION, relativePath)}`;
...
var Http = class {
  ...
  async readStaticFile(relativePath) {
    ...
    if (process.env.AMPT_ASSETS_LOCATION) {
      ...
      result = createReadableStream(import_node_path.default.join("static", relativePath));
    }
    if (this.useNode) {
      if (result && result instanceof ReadableStream) {
        const nodeStream = import_node_stream3.default.Readable.fromWeb(result);
        return nodeStream;
      } else {
        return result;
      }
