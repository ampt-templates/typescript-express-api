...
async function loadDefaultProvider() {
  if (!defaultProvider) {
    const { fromNodeProviderChain } = await import("./dist-es-H6SE5YRQ.js");
    defaultProvider = fromNodeProviderChain();
  }
...
async function loadCredentials() {
  ...
  const defaultProvider2 = await loadDefaultProvider();
  for (let attempt = 0; attempt < 10; attempt++) {
    try {
      return await defaultProvider2();
    } catch (err) {
