...
var require_typed_arrays = __commonJS({
  "../../node_modules/mnemonist/utils/typed-arrays.js"(exports) {
    ...
    exports.getMinimalRepresentation = function(array, getter) {
      var maxType = null, maxPriority = 0, p6, t4, v4, i6, l6;
      for (i6 = 0, l6 = array.length; i6 < l6; i6++) {
        v4 = getter ? getter(array[i6]) : array[i6];
        t4 = exports.getNumberType(v4);
    ...
    if (g6[n6])
      i6[n6] = function(v4) {
        return new Promise(function(a6, b6) {
          q6.push([n6, v4, a6, b6]) > 1 || resume(n6, v4);
        });
      };
  }
  function resume(n6, v4) {
    try {
      step(g6[n6](v4));
    } catch (e6) {
      settle(q6[0][3], e6);
...
function __asyncDelegator(o6) {
  ...
  function verb(n6, f6) {
    i6[n6] = o6[n6] ? function(v4) {
      return (p6 = !p6) ? { value: __await(o6[n6](v4)), done: n6 === "return" } : f6 ? f6(v4) : v4;
    } : f6;
  }
}
  ...
  function verb(n6) {
    i6[n6] = o6[n6] && function(v4) {
      return new Promise(function(resolve, reject) {
        v4 = o6[n6](v4), settle(resolve, reject, v4.done, v4.value);
      });
    };
  }
  function settle(resolve, reject, d6, v4) {
    Promise.resolve(v4).then(function(v5) {
      resolve({ value: v5, done: d6 });
    }, reject);
  }
}
...
var require_throat = __commonJS({
  "../../node_modules/throat/index.js"(exports, module2) {
    ...
    function throatInternal(size) {
      ...
      function runDelayed(d6) {
        try {
          return Promise.resolve(d6.fn.apply(d6.self, d6.args)).then(
            onFulfill,
            onReject
          );
        } catch (ex) {
...
var require_dayjs_min = __commonJS({
  "../../node_modules/dayjs/dayjs.min.js"(exports, module2) {
    !function(t4, e6) {
      "object" == typeof exports && "undefined" != typeof module2 ? module2.exports = e6() : "function" == typeof define && define.amd ? define(e6) : (t4 = "undefined" != typeof globalThis ? globalThis : t4 || self).dayjs = e6();
    }(exports, function() {
      "use strict";
      var t4 = 1e3, e6 = 6e4, n6 = 36e5, r6 = "millisecond", i6 = "second", s6 = "minute", u4 = "hour", a6 = "day", o6 = "week", f6 = "month", h6 = "quarter", c6 = "year", d6 = "date", l6 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y2 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t5) {
        var e7 = ["th", "st", "nd", "rd"], n7 = t5 % 100;
        return "[" + t5 + (e7[(n7 - 20) % 10] || e7[n7] || e7[0]) + "]";
      } }, m6 = function(t5, e7, n7) {
        var r7 = String(t5);
        return !r7 || r7.length >= e7 ? t5 : "" + Array(e7 + 1 - r7.length).join(n7) + t5;
      }, v4 = { s: m6, z: function(t5) {
        var e7 = -t5.utcOffset(), n7 = Math.abs(e7), r7 = Math.floor(n7 / 60), i7 = n7 % 60;
        return (e7 <= 0 ? "+" : "-") + m6(r7, 2, "0") + ":" + m6(i7, 2, "0");
      }, m: function t5(e7, n7) {
        if (e7.date() < n7.date())
          return -t5(n7, e7);
        var r7 = 12 * (n7.year() - e7.year()) + (n7.month() - e7.month()), i7 = e7.clone().add(r7, f6), s7 = n7 - i7 < 0, u5 = e7.clone().add(r7 + (s7 ? -1 : 1), f6);
        return +(-(r7 + (n7 - i7) / (s7 ? i7 - u5 : u5 - i7)) || 0);
      }, a: function(t5) {
        return t5 < 0 ? Math.ceil(t5) || 0 : Math.floor(t5);
      }, p: function(t5) {
        return { M: f6, y: c6, w: o6, d: a6, D: d6, h: u4, m: s6, s: i6, ms: r6, Q: h6 }[t5] || String(t5 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t5) {
        return void 0 === t5;
      } }, g6 = "en", D2 = {};
      D2[g6] = M;
      var p6 = function(t5) {
        return t5 instanceof _;
      }, S = function t5(e7, n7, r7) {
        var i7;
        if (!e7)
          return g6;
        if ("string" == typeof e7) {
          var s7 = e7.toLowerCase();
          D2[s7] && (i7 = s7), n7 && (D2[s7] = n7, i7 = s7);
          var u5 = e7.split("-");
          if (!i7 && u5.length > 1)
            return t5(u5[0]);
        } else {
        ...
        return !r7 && i7 && (g6 = i7), i7 || !r7 && g6;
      }, w3 = function(t5, e7) {
        if (p6(t5))
          return t5.clone();
        var n7 = "object" == typeof e7 ? e7 : {};
        return n7.date = t5, n7.args = arguments, new _(n7);
      }, O = v4;
      O.l = S, O.i = p6, O.w = function(t5, e7) {
        return w3(t5, { locale: e7.$L, utc: e7.$u, x: e7.$x, $offset: e7.$offset });
      };
      var _ = function() {
        function M2(t5) {
          this.$L = S(t5.locale, null, true), this.parse(t5);
        }
        var m7 = M2.prototype;
        return m7.parse = function(t5) {
          this.$d = function(t6) {
            var e7 = t6.date, n7 = t6.utc;
            if (null === e7)
            ...
            if ("string" == typeof e7 && !/Z$/i.test(e7)) {
              var r7 = e7.match($);
              if (r7) {
                var i7 = r7[2] - 1 || 0, s7 = (r7[7] || "0").substring(0, 3);
                return n7 ? new Date(Date.UTC(r7[1], i7, r7[3] || 1, r7[4] || 0, r7[5] || 0, r7[6] || 0, s7)) : new Date(r7[1], i7, r7[3] || 1, r7[4] || 0, r7[5] || 0, r7[6] || 0, s7);
              }
            }
            return new Date(e7);
        ...
        }, m7.isSame = function(t5, e7) {
          var n7 = w3(t5);
          return this.startOf(e7) <= n7 && n7 <= this.endOf(e7);
        }, m7.isAfter = function(t5, e7) {
          return w3(t5) < this.startOf(e7);
        }, m7.isBefore = function(t5, e7) {
          return this.endOf(e7) < w3(t5);
        }, m7.$g = function(t5, e7, n7) {
          return O.u(t5) ? this[e7] : this.set(n7, t5);
        }, m7.unix = function() {
          return Math.floor(this.valueOf() / 1e3);
        }, m7.valueOf = function() {
          return this.$d.getTime();
        }, m7.startOf = function(t5, e7) {
          var n7 = this, r7 = !!O.u(e7) || e7, h7 = O.p(t5), l7 = function(t6, e8) {
            var i7 = O.w(n7.$u ? Date.UTC(n7.$y, e8, t6) : new Date(n7.$y, e8, t6), n7);
            return r7 ? i7 : i7.endOf(a6);
          }, $2 = function(t6, e8) {
            return O.w(n7.toDate()[t6].apply(n7.toDate("s"), (r7 ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e8)), n7);
          }, y3 = this.$W, M3 = this.$M, m8 = this.$D, v5 = "set" + (this.$u ? "UTC" : "");
          switch (h7) {
            case c6:
              return r7 ? l7(1, 0) : l7(31, 11);
            case f6:
              return r7 ? l7(1, M3) : l7(0, M3 + 1);
            case o6:
              var g7 = this.$locale().weekStart || 0, D3 = (y3 < g7 ? y3 + 7 : y3) - g7;
              return l7(r7 ? m8 - D3 : m8 + (6 - D3), M3);
            case a6:
            case d6:
              return $2(v5 + "Hours", 0);
            case u4:
        ...
        }, m7.$set = function(t5, e7) {
          var n7, o7 = O.p(t5), h7 = "set" + (this.$u ? "UTC" : ""), l7 = (n7 = {}, n7[a6] = h7 + "Date", n7[d6] = h7 + "Date", n7[f6] = h7 + "Month", n7[c6] = h7 + "FullYear", n7[u4] = h7 + "Hours", n7[s6] = h7 + "Minutes", n7[i6] = h7 + "Seconds", n7[r6] = h7 + "Milliseconds", n7)[o7], $2 = o7 === a6 ? this.$D + (e7 - this.$W) : e7;
          if (o7 === f6 || o7 === c6) {
            var y3 = this.clone().set(d6, 1);
            y3.$d[l7]($2), y3.init(), this.$d = y3.set(d6, Math.min(this.$D, y3.daysInMonth())).$d;
          } else
            l7 && this.$d[l7]($2);
          ...
          return this[O.p(t5)]();
        }, m7.add = function(r7, h7) {
          var d7, l7 = this;
          r7 = Number(r7);
          var $2 = O.p(h7), y3 = function(t5) {
            var e7 = w3(l7);
            return O.w(e7.date(e7.date() + Math.round(t5 * r7)), l7);
          };
          if ($2 === f6)
            return this.set(f6, this.$M + r7);
          if ($2 === c6)
            return this.set(c6, this.$y + r7);
          if ($2 === a6)
            return y3(1);
          if ($2 === o6)
            return y3(7);
          var M3 = (d7 = {}, d7[s6] = e6, d7[u4] = n6, d7[i6] = t4, d7)[$2] || 1, m8 = this.$d.getTime() + r7 * M3;
          return O.w(m8, this);
        }, m7.subtract = function(t5, e7) {
          return this.add(-1 * t5, e7);
        }, m7.format = function(t5) {
          var e7 = this, n7 = this.$locale();
          if (!this.isValid())
            return n7.invalidDate || l6;
          var r7 = t5 || "YYYY-MM-DDTHH:mm:ssZ", i7 = O.z(this), s7 = this.$H, u5 = this.$m, a7 = this.$M, o7 = n7.weekdays, f7 = n7.months, h7 = function(t6, n8, i8, s8) {
            return t6 && (t6[n8] || t6(e7, r7)) || i8[n8].slice(0, s8);
          }, c7 = function(t6) {
            return O.s(s7 % 12 || 12, t6, "0");
          }, d7 = n7.meridiem || function(t6, e8, n8) {
            var r8 = t6 < 12 ? "AM" : "PM";
            return n8 ? r8.toLowerCase() : r8;
          }, $2 = { YY: String(this.$y).slice(-2), YYYY: this.$y, M: a7 + 1, MM: O.s(a7 + 1, 2, "0"), MMM: h7(n7.monthsShort, a7, f7, 3), MMMM: h7(f7, a7), D: this.$D, DD: O.s(this.$D, 2, "0"), d: String(this.$W), dd: h7(n7.weekdaysMin, this.$W, o7, 2), ddd: h7(n7.weekdaysShort, this.$W, o7, 3), dddd: o7[this.$W], H: String(s7), HH: O.s(s7, 2, "0"), h: c7(1), hh: c7(2), a: d7(s7, u5, true), A: d7(s7, u5, false), m: String(u5), mm: O.s(u5, 2, "0"), s: String(this.$s), ss: O.s(this.$s, 2, "0"), SSS: O.s(this.$ms, 3, "0"), Z: i7 };
          return r7.replace(y2, function(t6, e8) {
            return e8 || $2[t6] || i7.replace(":", "");
          });
        }, m7.utcOffset = function() {
          return 15 * -Math.round(this.$d.getTimezoneOffset() / 15);
        }, m7.diff = function(r7, d7, l7) {
          var $2, y3 = O.p(d7), M3 = w3(r7), m8 = (M3.utcOffset() - this.utcOffset()) * e6, v5 = this - M3, g7 = O.m(this, M3);
          return g7 = ($2 = {}, $2[c6] = g7 / 12, $2[f6] = g7, $2[h6] = g7 / 3, $2[o6] = (v5 - m8) / 6048e5, $2[a6] = (v5 - m8) / 864e5, $2[u4] = v5 / n6, $2[s6] = v5 / e6, $2[i6] = v5 / t4, $2)[y3] || v5, l7 ? g7 : O.a(g7);
        }, m7.daysInMonth = function() {
          return this.endOf(f6).$D;
        }, m7.$locale = function() {
          return D2[this.$L];
        }, m7.locale = function(t5, e7) {
          if (!t5)
            return this.$L;
          var n7 = this.clone(), r7 = S(t5, e7, true);
      ...
      return w3.prototype = T, [["$ms", r6], ["$s", i6], ["$m", s6], ["$H", u4], ["$W", a6], ["$M", f6], ["$y", c6], ["$D", d6]].forEach(function(t5) {
        T[t5[1]] = function(e7) {
          return this.$g(e7, t5[0], t5[1]);
        };
      }), w3.extend = function(t5, e7) {
        return t5.$i || (t5(e7, _, w3), t5.$i = true), w3;
      }, w3.locale = S, w3.isDayjs = p6, w3.unix = function(t5) {
        return w3(1e3 * t5);
      }, w3.en = D2[g6], w3.Ls = D2, w3.p = {}, w3;
    });
  }
});
...
var require_utc = __commonJS({
  "../../node_modules/dayjs/plugin/utc.js"(exports, module2) {
    !function(t4, i6) {
      "object" == typeof exports && "undefined" != typeof module2 ? module2.exports = i6() : "function" == typeof define && define.amd ? define(i6) : (t4 = "undefined" != typeof globalThis ? globalThis : t4 || self).dayjs_plugin_utc = i6();
    }(exports, function() {
      "use strict";
      var t4 = "minute", i6 = /[+-]\d\d(?::?\d\d)?/g, e6 = /([+-]|\d\d)/g;
      return function(s6, f6, n6) {
        var u4 = f6.prototype;
        n6.utc = function(t5) {
          var i7 = { date: t5, utc: true, args: arguments };
          return new f6(i7);
        }, u4.utc = function(i7) {
          var e7 = n6(this.toDate(), { locale: this.$L, utc: true });
          return i7 ? e7.add(this.utcOffset(), t4) : e7;
        }, u4.local = function() {
          return n6(this.toDate(), { locale: this.$L, utc: false });
        };
        var o6 = u4.parse;
        u4.parse = function(t5) {
        ...
        var a6 = u4.utcOffset;
        u4.utcOffset = function(s7, f7) {
          var n7 = this.$utils().u;
          if (n7(s7))
            return this.$u ? 0 : n7(this.$offset) ? a6.call(this) : this.$offset;
          if ("string" == typeof s7 && (s7 = function(t5) {
            void 0 === t5 && (t5 = "");
            var s8 = t5.match(i6);
            if (!s8)
              return null;
            var f8 = ("" + s8[0]).match(e6) || ["-", 0, 0], n8 = f8[0], u6 = 60 * +f8[1] + +f8[2];
            return 0 === u6 ? 0 : "+" === n8 ? u6 : -u6;
          }(s7), null === s7))
            return this;
          var u5 = Math.abs(s7) <= 16 ? 60 * s7 : s7, o7 = this;
          if (f7)
            return o7.$offset = u5, o7.$u = 0 === s7, o7;
          if (0 !== s7) {
            var r7 = this.$u ? this.toDate().getTimezoneOffset() : -1 * this.utcOffset();
            (o7 = this.local().add(u5 + r7, t4)).$offset = u5, o7.$x.$localOffset = r7;
          } else
            o7 = this.utc();
          return o7;
        };
        var h6 = u4.format;
        u4.format = function(t5) {
          var i7 = t5 || (this.$u ? "YYYY-MM-DDTHH:mm:ss[Z]" : "");
          return h6.call(this, i7);
        }, u4.valueOf = function() {
        ...
        var l6 = u4.toDate;
        u4.toDate = function(t5) {
          return "s" === t5 && this.$offset ? n6(this.format("YYYY-MM-DD HH:mm:ss:SSS")).toDate() : l6.call(this);
        };
        var c6 = u4.diff;
        u4.diff = function(t5, i7, e7) {
          if (t5 && this.$u === t5.$u)
            return c6.call(this, t5, i7, e7);
          var s7 = this.local(), f7 = n6(t5).local();
          return c6.call(s7, f7, i7, e7);
        };
      };
    });
  }
...
var d = "endpoint";
var e = "getAttr";
var f = { [s]: false, "type": "String" };
var g = { [s]: true, "default": false, "type": "Boolean" };
var h = { [v]: "Endpoint" };
var i = { [t]: "booleanEquals", [u]: [{ [v]: "UseFIPS" }, true] };
var j = { [t]: "booleanEquals", [u]: [{ [v]: "UseDualStack" }, true] };
var k = {};
var l = { [t]: "booleanEquals", [u]: [true, { [t]: e, [u]: [{ [v]: a }, "supportsFIPS"] }] };
var m = { [v]: a };
var n = { [t]: "booleanEquals", [u]: [true, { [t]: e, [u]: [m, "supportsDualStack"] }] };
var o = { "url": "https://sqs.{Region}.{PartitionResult#dnsSuffix}", "properties": {}, "headers": {} };
var p = [h];
var q = [i];
var r = [j];
...
var recursionDetectionMiddleware = (options) => (next) => async (args) => {
  const { request: request2 } = args;
  if (!HttpRequest2.isInstance(request2) || options.runtime !== "node" || request2.headers.hasOwnProperty(TRACE_ID_HEADER_NAME)) {
    return next(args);
  }
...
var toUtf85 = (input) => fromArrayBuffer(input.buffer, input.byteOffset, input.byteLength).toString("utf8");
  ...
  const whatwgURL = (() => {
    try {
      ...
      if (typeof value === "object" && "hostname" in value) {
        ...
        url.search = Object.entries(query).map(([k6, v4]) => `${k6}=${v4}`).join("&");
        return url;
      }
...
var resolveEndpoint2 = (ruleSetObject, options) => {
  ...
  const paramsWithDefault = Object.entries(parameters).filter(([, v4]) => v4.default != null).map(([k6, v4]) => [k6, v4.default]);
  if (paramsWithDefault.length > 0) {
    for (const [paramKey, paramDefaultValue] of paramsWithDefault) {
      endpointParams[paramKey] = endpointParams[paramKey] ?? paramDefaultValue;
    }
  }
  const requiredParams = Object.entries(parameters).filter(([, v4]) => v4.required).map(([k6]) => k6);
...
var userAgentMiddleware = (options) => (next, context) => async (args) => {
  ...
  const sdkUserAgentValue = (prefix ? [prefix] : []).concat([...defaultUserAgent3, ...userAgent, ...customUserAgent]).join(SPACE);
  const normalUAValue = [
...
var toBase642 = (input) => fromArrayBuffer(input.buffer, input.byteOffset, input.byteLength).toString("base64");
...
var expectUnion = (value) => {
  ...
  const setKeys = Object.entries(asObject).filter(([, v4]) => v4 != null).map(([k6]) => k6);
  if (setKeys.length === 0) {
...
var decorateServiceException2 = (exception, additions = {}) => {
  Object.entries(additions).filter(([, v4]) => v4 !== void 0).forEach(([k6, v4]) => {
...
var STSServiceException = class extends ServiceException2 {
  constructor(options) {
    super(options);
...
var de_AssumeRoleCommand = async (output, context) => {
  ...
  const data = await parseBody3(output.body, context);
  let contents = {};
...
var throwDefaultError4 = withBaseException(STSServiceException);
...
var AssumeRoleCommand = class extends Command2 {
  static getEndpointParameterInstructions() {
    return {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin2(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(getEndpointPlugin2(configuration, AssumeRoleCommand.getEndpointParameterInstructions()));
...
var AssumeRoleWithWebIdentityCommand = class extends Command2 {
  static getEndpointParameterInstructions() {
    return {
      UseGlobalEndpoint: { type: "builtInParams", name: "useGlobalEndpoint" },
      UseFIPS: { type: "builtInParams", name: "useFipsEndpoint" },
  ...
  resolveMiddleware(clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin2(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(getEndpointPlugin2(configuration, AssumeRoleWithWebIdentityCommand.getEndpointParameterInstructions()));
    const stack = clientStack.concat(this.middlewareStack);
    const { logger: logger2 } = configuration;
    const clientName = "STSClient";
...
var loadConfig2 = ({ environmentVariableSelector, configFileSelector, default: defaultValue }, configuration = {}) => memoize(chain(fromEnv2(environmentVariableSelector), fromSharedConfigFiles(configFileSelector, configuration), fromStatic2(defaultValue)));
...
var n2 = [h2];
var o2 = [i2];
var _data2 = { version: "1.0", parameters: { Region: e2, UseDualStack: f2, UseFIPS: f2, Endpoint: e2 }, rules: [{ conditions: [{ [q2]: "aws.partition", [r2]: [{ [s2]: "Region" }], assign: a2 }], type: b2, rules: [{ conditions: [{ [q2]: "isSet", [r2]: m2 }, { [q2]: "parseURL", [r2]: m2, assign: "url" }], type: b2, rules: [{ conditions: n2, error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: c2 }, { type: b2, rules: [{ conditions: o2, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", type: c2 }, { endpoint: { url: g2, properties: j2, headers: j2 }, type: d2 }] }] }, { conditions: [h2, i2], type: b2, rules: [{ conditions: [k2, l2], type: b2, rules: [{ endpoint: { url: "https://portal.sso-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: j2, headers: j2 }, type: d2 }] }, { error: "FIPS and DualStack are enabled, but this partition does not support one or both", type: c2 }] }, { conditions: n2, type: b2, rules: [{ conditions: [k2], type: b2, rules: [{ type: b2, rules: [{ endpoint: { url: "https://portal.sso-fips.{Region}.{PartitionResult#dnsSuffix}", properties: j2, headers: j2 }, type: d2 }] }] }, { error: "FIPS is enabled but this partition does not support FIPS", type: c2 }] }, { conditions: o2, type: b2, rules: [{ conditions: [l2], type: b2, rules: [{ endpoint: { url: "https://portal.sso.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: j2, headers: j2 }, type: d2 }] }, { error: "DualStack is enabled but this partition does not support DualStack", type: c2 }] }, { endpoint: { url: "https://portal.sso.{Region}.{PartitionResult#dnsSuffix}", properties: j2, headers: j2 }, type: d2 }] }] };
var ruleSet2 = _data2;
...
var defaultEndpointResolver2 = (endpointParams, context = {}) => {
  return resolveEndpoint2(ruleSet2, {
    endpointParams,
    logger: context.logger
  });
};
...
var resolveDefaultsModeConfig2 = ({ region = loadConfig2(NODE_REGION_CONFIG_OPTIONS2), defaultsMode = loadConfig2(NODE_DEFAULTS_MODE_CONFIG_OPTIONS) } = {}) => memoize(async () => {
...
var getRuntimeConfig4 = (config) => {
  ...
  return {
    ...
    defaultUserAgentProvider: config?.defaultUserAgentProvider ?? defaultUserAgent2({ serviceId: clientSharedValues.serviceId, clientVersion: package_default4.version }),
...
var SSOClient = class extends Client2 {
  constructor(configuration) {
...
var SSOServiceException = class extends ServiceException2 {
  constructor(options) {
    super(options);
...
var throwDefaultError5 = withBaseException(SSOServiceException);
...
var GetRoleCredentialsCommand = class extends Command2 {
  static getEndpointParameterInstructions() {
    return {
      UseFIPS: { type: "builtInParams", name: "useFipsEndpoint" },
      Endpoint: { type: "builtInParams", name: "endpoint" },
  ...
  resolveMiddleware(clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin2(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(getEndpointPlugin2(configuration, GetRoleCredentialsCommand.getEndpointParameterInstructions()));
    const stack = clientStack.concat(this.middlewareStack);
    const { logger: logger2 } = configuration;
...
var r3 = "argv";
var s3 = "ref";
var a3 = "PartitionResult";
var b3 = "tree";
var c3 = "error";
var d3 = "endpoint";
var e3 = { [p3]: false, "type": "String" };
var f3 = { [p3]: true, "default": false, "type": "Boolean" };
var g3 = { [s3]: "Endpoint" };
var h3 = { [q3]: "booleanEquals", [r3]: [{ [s3]: "UseFIPS" }, true] };
var i3 = { [q3]: "booleanEquals", [r3]: [{ [s3]: "UseDualStack" }, true] };
var j3 = {};
var k3 = { [q3]: "booleanEquals", [r3]: [true, { [q3]: "getAttr", [r3]: [{ [s3]: a3 }, "supportsFIPS"] }] };
var l3 = { [q3]: "booleanEquals", [r3]: [true, { [q3]: "getAttr", [r3]: [{ [s3]: a3 }, "supportsDualStack"] }] };
var m3 = [g3];
var n3 = [h3];
var o3 = [i3];
var _data3 = { version: "1.0", parameters: { Region: e3, UseDualStack: f3, UseFIPS: f3, Endpoint: e3 }, rules: [{ conditions: [{ [q3]: "aws.partition", [r3]: [{ [s3]: "Region" }], assign: a3 }], type: b3, rules: [{ conditions: [{ [q3]: "isSet", [r3]: m3 }, { [q3]: "parseURL", [r3]: m3, assign: "url" }], type: b3, rules: [{ conditions: n3, error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: c3 }, { type: b3, rules: [{ conditions: o3, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", type: c3 }, { endpoint: { url: g3, properties: j3, headers: j3 }, type: d3 }] }] }, { conditions: [h3, i3], type: b3, rules: [{ conditions: [k3, l3], type: b3, rules: [{ endpoint: { url: "https://oidc-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: j3, headers: j3 }, type: d3 }] }, { error: "FIPS and DualStack are enabled, but this partition does not support one or both", type: c3 }] }, { conditions: n3, type: b3, rules: [{ conditions: [k3], type: b3, rules: [{ type: b3, rules: [{ endpoint: { url: "https://oidc-fips.{Region}.{PartitionResult#dnsSuffix}", properties: j3, headers: j3 }, type: d3 }] }] }, { error: "FIPS is enabled but this partition does not support FIPS", type: c3 }] }, { conditions: o3, type: b3, rules: [{ conditions: [l3], type: b3, rules: [{ endpoint: { url: "https://oidc.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: j3, headers: j3 }, type: d3 }] }, { error: "DualStack is enabled but this partition does not support DualStack", type: c3 }] }, { endpoint: { url: "https://oidc.{Region}.{PartitionResult#dnsSuffix}", properties: j3, headers: j3 }, type: d3 }] }] };
var ruleSet3 = _data3;
...
var defaultEndpointResolver3 = (endpointParams, context = {}) => {
  return resolveEndpoint2(ruleSet3, {
    endpointParams,
    logger: context.logger
  });
};
...
var SSOOIDCClient = class extends Client2 {
  constructor(configuration) {
...
var SSOOIDCServiceException = class extends ServiceException2 {
  constructor(options) {
    super(options);
...
var de_CreateTokenCommand = async (output, context) => {
  ...
  const data = expectNonNull(expectObject(await parseBody5(output.body, context)), "body");
  const doc = take(data, {
...
var throwDefaultError6 = withBaseException(SSOOIDCServiceException);
...
var CreateTokenCommand = class extends Command2 {
  static getEndpointParameterInstructions() {
    return {
      UseFIPS: { type: "builtInParams", name: "useFipsEndpoint" },
      Endpoint: { type: "builtInParams", name: "endpoint" },
  ...
  resolveMiddleware(clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin2(configuration, this.serialize, this.deserialize));
    this.middlewareStack.use(getEndpointPlugin2(configuration, CreateTokenCommand.getEndpointParameterInstructions()));
    const stack = clientStack.concat(this.middlewareStack);
    const { logger: logger2 } = configuration;
...
var defaultProvider2 = (init = {}) => memoize(chain(...init.profile || process.env[ENV_PROFILE] ? [] : [fromEnv()], fromSSO(init), fromIni(init), fromProcess(init), fromTokenFile(init), remoteProvider(init), async () => {
...
var h4 = "us-east-1";
var i4 = "endpoint";
var j4 = "https://sts.{Region}.{PartitionResult#dnsSuffix}";
var k4 = "error";
var l4 = "getAttr";
var m4 = { [F]: false, [G]: "String" };
var n4 = { [F]: true, "default": false, [G]: "Boolean" };
var o4 = { [J]: "Endpoint" };
var p4 = { [H]: "isSet", [I]: [{ [J]: "Region" }] };
var q4 = { [J]: "Region" };
var r4 = { [H]: "aws.partition", [I]: [q4], "assign": "PartitionResult" };
var s4 = { [J]: "UseFIPS" };
var t2 = { [J]: "UseDualStack" };
var u2 = { "url": "https://sts.amazonaws.com", "properties": { "authSchemes": [{ "name": f4, "signingName": g4, "signingRegion": h4 }] }, "headers": {} };
var v2 = {};
var w = { "conditions": [{ [H]: e4, [I]: [q4, "aws-global"] }], [i4]: u2, [G]: i4 };
var x = { [H]: c4, [I]: [s4, true] };
var y = { [H]: c4, [I]: [t2, true] };
var z = { [H]: c4, [I]: [true, { [H]: l4, [I]: [{ [J]: "PartitionResult" }, "supportsFIPS"] }] };
var A = { [J]: "PartitionResult" };
var B = { [H]: c4, [I]: [true, { [H]: l4, [I]: [A, "supportsDualStack"] }] };
var C = [{ [H]: "isSet", [I]: [o4] }];
var D = [x];
var E = [y];
var _data4 = { version: "1.0", parameters: { Region: m4, UseDualStack: n4, UseFIPS: n4, Endpoint: m4, UseGlobalEndpoint: n4 }, rules: [{ conditions: [{ [H]: c4, [I]: [{ [J]: "UseGlobalEndpoint" }, b4] }, { [H]: "not", [I]: C }, p4, r4, { [H]: c4, [I]: [s4, a4] }, { [H]: c4, [I]: [t2, a4] }], [G]: d4, rules: [{ conditions: [{ [H]: e4, [I]: [q4, "ap-northeast-1"] }], endpoint: u2, [G]: i4 }, { conditions: [{ [H]: e4, [I]: [q4, "ap-south-1"] }], endpoint: u2, [G]: i4 }, { conditions: [{ [H]: e4, [I]: [q4, "ap-southeast-1"] }], endpoint: u2, [G]: i4 }, { conditions: [{ [H]: e4, [I]: [q4, "ap-southeast-2"] }], endpoint: u2, [G]: i4 }, w, { conditions: [{ [H]: e4, [I]: [q4, "ca-central-1"] }], endpoint: u2, [G]: i4 }, { conditions: [{ [H]: e4, [I]: [q4, "eu-central-1"] }], endpoint: u2, [G]: i4 }, { conditions: [{ [H]: e4, [I]: [q4, "eu-north-1"] }], endpoint: u2, [G]: i4 }, { conditions: [{ [H]: e4, [I]: [q4, "eu-west-1"] }], endpoint: u2, [G]: i4 }, { conditions: [{ [H]: e4, [I]: [q4, "eu-west-2"] }], endpoint: u2, [G]: i4 }, { conditions: [{ [H]: e4, [I]: [q4, "eu-west-3"] }], endpoint: u2, [G]: i4 }, { conditions: [{ [H]: e4, [I]: [q4, "sa-east-1"] }], endpoint: u2, [G]: i4 }, { conditions: [{ [H]: e4, [I]: [q4, h4] }], endpoint: u2, [G]: i4 }, { conditions: [{ [H]: e4, [I]: [q4, "us-east-2"] }], endpoint: u2, [G]: i4 }, { conditions: [{ [H]: e4, [I]: [q4, "us-west-1"] }], endpoint: u2, [G]: i4 }, { conditions: [{ [H]: e4, [I]: [q4, "us-west-2"] }], endpoint: u2, [G]: i4 }, { endpoint: { url: j4, properties: { authSchemes: [{ name: f4, signingName: g4, signingRegion: "{Region}" }] }, headers: v2 }, [G]: i4 }] }, { conditions: C, [G]: d4, rules: [{ conditions: D, error: "Invalid Configuration: FIPS and custom endpoint are not supported", [G]: k4 }, { [G]: d4, rules: [{ conditions: E, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", [G]: k4 }, { endpoint: { url: o4, properties: v2, headers: v2 }, [G]: i4 }] }] }, { [G]: d4, rules: [{ conditions: [p4], [G]: d4, rules: [{ conditions: [r4], [G]: d4, rules: [{ conditions: [x, y], [G]: d4, rules: [{ conditions: [z, B], [G]: d4, rules: [{ [G]: d4, rules: [{ endpoint: { url: "https://sts-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: v2, headers: v2 }, [G]: i4 }] }] }, { error: "FIPS and DualStack are enabled, but this partition does not support one or both", [G]: k4 }] }, { conditions: D, [G]: d4, rules: [{ conditions: [z], [G]: d4, rules: [{ [G]: d4, rules: [{ conditions: [{ [H]: e4, [I]: ["aws-us-gov", { [H]: l4, [I]: [A, "name"] }] }], endpoint: { url: "https://sts.{Region}.amazonaws.com", properties: v2, headers: v2 }, [G]: i4 }, { endpoint: { url: "https://sts-fips.{Region}.{PartitionResult#dnsSuffix}", properties: v2, headers: v2 }, [G]: i4 }] }] }, { error: "FIPS is enabled but this partition does not support FIPS", [G]: k4 }] }, { conditions: E, [G]: d4, rules: [{ conditions: [B], [G]: d4, rules: [{ [G]: d4, rules: [{ endpoint: { url: "https://sts.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: v2, headers: v2 }, [G]: i4 }] }] }, { error: "DualStack is enabled but this partition does not support DualStack", [G]: k4 }] }, { [G]: d4, rules: [w, { endpoint: { url: j4, properties: v2, headers: v2 }, [G]: i4 }] }] }] }, { error: "Invalid Configuration: Missing Region", [G]: k4 }] }] };
var ruleSet4 = _data4;
...
var defaultEndpointResolver4 = (endpointParams, context = {}) => {
  return resolveEndpoint2(ruleSet4, {
    endpointParams,
    logger: context.logger
  });
};
...
var getRuntimeConfig8 = (config) => {
  ...
  return {
    ...
    defaultUserAgentProvider: config?.defaultUserAgentProvider ?? defaultUserAgent2({ serviceId: clientSharedValues.serviceId, clientVersion: package_default3.version }),
    maxAttempts: config?.maxAttempts ?? loadConfig2(NODE_MAX_ATTEMPT_CONFIG_OPTIONS2),
    region: config?.region ?? loadConfig2(NODE_REGION_CONFIG_OPTIONS2, NODE_REGION_CONFIG_FILE_OPTIONS2),
    requestHandler: config?.requestHandler ?? new NodeHttpHandler2(defaultConfigProvider),
    retryMode: config?.retryMode ?? loadConfig2({
...
var STSClient = class extends Client2 {
  constructor(configuration) {
...
var getRuntimeConfig10 = (config) => {
  ...
  return {
    ...
    defaultUserAgentProvider: config?.defaultUserAgentProvider ?? defaultUserAgent2({ serviceId: clientSharedValues.serviceId, clientVersion: package_default2.version }),
...
var calculateAttributeSizeInBytes = (attr) => {
  ...
  if (attr.hasOwnProperty("BS")) {
    let size = 0;
    for (let i6 = 0; i6 < attr.BS.length; i6++) {
      size += Buffer.from(attr.BS[i6], "base64").length;
    }
    return size;
  }
  if (attr.hasOwnProperty("SS")) {
    let size = 0;
    for (let i6 = 0; i6 < attr.SS.length; i6++) {
      size += Buffer.byteLength(attr.SS[i6]);
    }
    return size;
  }
  if (attr.hasOwnProperty("NS")) {
    let size = 0;
    for (let i6 = 0; i6 < attr.NS.length; i6++) {
      size += calculateNumberSizeInBytes(attr.NS[i6]);
    }
    return size;
  }
  ...
  if (attr.hasOwnProperty("L")) {
    let size = LOGICAL_SIZE_OF_EMPTY_DOCUMENT;
    for (let i6 = 0; i6 < attr.L.length; i6++) {
      size += calculateAttributeSizeInBytes(attr.L[i6]);
      size += BASE_LOGICAL_SIZE_OF_NESTED_TYPES;
    }
    return size;
  }
...
var calculateNumberSizeInBytes = (n6) => {
  const number = new Number(n6);
  if (number == 0) {
    return 1;
  }
...
var measure = (n6) => {
  ...
  n6 = zeros(n6, true, true);
  return Math.ceil(n6.length / 2);
};
var zeros = (n6, left, right) => {
  while (left && true) {
    const t4 = n6.replace(/^(0{2})/, "");
    if (t4.length == n6.length) {
      break;
    }
    n6 = t4;
  }
...
var set = (table, key, value, options = {}) => {
  ...
  if (overwrite) {
    ...
    if (isObj) {
      ...
      for (const i6 in attrs) {
        const val2 = mvalue[attrs[i6]];
        if (val2 === void 0 || val2 === null && removeNulls) {
          REMOVE.push(`#a${i6}`);
          names[`#a${i6}`] = `_${attrs[i6]}`;
        } else {
          ...
          val2["$add"] !== void 0) {
            if (value[attrs[i6]] !== mvalue[attrs[i6]]) {
              throw new ValidationError(`'$add' cannot be used as a default (${attrs[i6]})`);
            } else if (isNaN(val2["$add"])) {
              throw new ValidationError(`'${attrs[i6]}' must be a number when using $add`);
            } else {
              ADD.push(`#a${i6} :a${i6}`);
              names[`#a${i6}`] = `_${attrs[i6]}`;
              values[`:a${i6}`] = Number(val2["$add"]);
            }
          } else {
            value = value ?? {};
            if (value[attrs[i6]] === void 0 && value[attrs[i6]] !== mvalue[attrs[i6]]) {
              SET.push(`#a${i6} = if_not_exists(#a${i6},:a${i6})`);
            } else {
              SET.push(`#a${i6} = :a${i6}`);
            }
            names[`#a${i6}`] = `_${attrs[i6]}`;
    ...
    for (const i6 in labels) {
      if ((labels[i6] ?? void 0) === void 0) {
        REMOVE.push(`#pk${i6}`);
        REMOVE.push(`#sk${i6}`);
        REMOVE.push(`#kv${i6}`);
        names[`#pk${i6}`] = `pk${i6}`;
        ...
        if (labels[i6]?.default) {
          SET.push(`#pk${i6} = if_not_exists(#pk${i6},:pk${i6}),#sk${i6} = if_not_exists(#sk${i6},:sk${i6})`);
        } else {
          SET.push(`#pk${i6} = :pk${i6}, #sk${i6} = :sk${i6}`);
        }
        names[`#pk${i6}`] = `pk${i6}`;
        names[`#sk${i6}`] = `sk${i6}`;
        values[`:pk${i6}`] = labels[i6].pk;
        values[`:sk${i6}`] = labels[i6].sk;
        if (labels[i6].kv || labels[i6]?.default) {
          if (labels[i6]?.default) {
            SET.push(`#kv${i6} = if_not_exists(#kv${i6},:kv${i6})`);
          } else {
            SET.push(`#kv${i6} = :kv${i6}`);
          }
          names[`#kv${i6}`] = `kv${i6}`;
          values[`:kv${i6}`] = labels[i6].kv;
        } else {
          REMOVE.push(`#kv${i6}`);
          names[`#kv${i6}`] = `kv${i6}`;
        }
...
var formatAttrs = (data) => {
  return Object.keys(data).reduce((acc, x3) => {
    return Object.assign(acc, { [x3.substring(1)]: data[x3] });
  }, {});
};
...
var get2 = async (client, table, keys, options = {}) => {
  ...
  if (Array.isArray(keys)) {
    ...
    if (data.Responses) {
      return {
        items: data.Responses[table].map((x3) => parseResults(x3, meta, true))
      };
    }
  } else {
    ...
    if (data.Items) {
      if (!isQuery && label === void 0 && data.Items.length > 0) {
        ...
        return {
          items: data.Items.map((x3) => parseResults(x3, meta, true)),
  ...
  if (Array.isArray(keys)) {
    ...
    if (overwrite) {
      ...
      try {
        ...
        if (e6.name === "ConditionalCheckFailedException") {
          if (exists === false && e6.Item !== void 0) {
            throw new Error("Item already exists");
          } else if (exists === true && e6.Item === void 0) {
      ...
      try {
        ...
        if (e6.name === "ConditionalCheckFailedException") {
          ...
          if (e6.name === "ValidationException") {
            if (e6.message === "Item size to update has exceeded the maximum allowed size") {
